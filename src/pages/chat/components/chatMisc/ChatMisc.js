...
function ChatMisc() {
  ...
  const currentFriendName = toTitleCase(friend_username);
  return (
    <>
      {friend_id ? <Wrapper>
        <div className="misc">
          <div className="misc-upper-part">
            <div className="misc-upper-part-heading">{currentFriendName}'s Details</div>
            <div className="misc-upper-part-dp">
              <img src={ProfilePic} alt="dp" className="misc-upper-part-dp-img" />
            </div>
            <div className="misc-upper-part-name">{currentFriendName}</div>
